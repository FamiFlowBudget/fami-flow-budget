...
import { NoFamilyAssociated } from './NoFamilyAssociated'; // <<<--- IMPORTAMOS EL NUEVO COMPONENTE
...
    familyMembers, 
    joinRequests,
    createFamily, // <<<--- Necesitamos esta función
    requestToJoinFamilyByCode, // <<<--- Y nuestra nueva función
    handleJoinRequest, 
    createInvitation,
    loading 
  } = useFamilies();
...
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                  _       <AlertDialogCancel>Cancelar</AlertDialogCancel>
                          <AlertDialogAction 
